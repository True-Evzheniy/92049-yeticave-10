...
* Восстановите базу с помощью schema.sql
* В файле config/db.php замените настройки подключения к БД
* В файле config/mail.php замените настройки подключения к почтовому сеоверу
