...
<div class="page-wrapper">
    ...
    <header class="main-header">
        <div class="main-header__container container">
            ...
            <form class="main-header__search" method="get" action="/pages/search.php" autocomplete="off">
            ...
            <nav class="user-menu">
                ...
                <?php if($is_auth): ?>
                    <div class="user-menu__logged">
                        <p><?=$user_name;?></p>
                        <a class="user-menu__bets" href="/pages/my-bets.php">Мои ставки</a>
                        <a class="user-menu__logout" href="/pages/logout.php">Выход</a>
                    </div>
                <?php else: ?>
                    <ul class="user-menu__list">
                        <li class="user-menu__item">
                            <a href="/pages/sign-up.php">Регистрация</a>
                        </li>
                        <li class="user-menu__item">
